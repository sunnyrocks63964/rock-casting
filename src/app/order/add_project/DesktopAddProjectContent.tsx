...
function DesktopAddProjectContent() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
            <LoginedHeader />
            <LoginedNavBar />
            <div style={{ flex: 1, backgroundColor: "#060606", padding: "20px 200px" }}>
                <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
                    ...
                    <Form form={form} layout="vertical" onFinish={handleSubmit} style={{ width: "100%" }}>
                        <ProjectForm form={form} defaultDetailTemplate={DEFAULT_DETAIL_TEMPLATE} />
...
export default DesktopAddProjectContent;
