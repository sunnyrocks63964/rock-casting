...
interface DesktopPackageReservateSearchedProps {
    userId: string;
    ordererId: string;
...
const DesktopPackageReservateSearched = ({
    userId,
    ordererId,
    professionCounts,
    isAuthorized,
}: DesktopPackageReservateSearchedProps) => {
...
export default DesktopPackageReservateSearched;
