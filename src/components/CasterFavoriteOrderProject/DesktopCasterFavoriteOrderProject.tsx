...
interface DesktopCasterFavoriteOrderProjectProps {
    casterId: string;
}

const DesktopCasterFavoriteOrderProject = ({ casterId }: DesktopCasterFavoriteOrderProjectProps) => {
...
export default DesktopCasterFavoriteOrderProject;
