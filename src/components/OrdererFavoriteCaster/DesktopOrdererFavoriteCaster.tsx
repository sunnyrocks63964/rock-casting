...
interface DesktopOrdererFavoriteCasterProps {
    ordererId: string;
}

const DesktopOrdererFavoriteCaster = ({ ordererId }: DesktopOrdererFavoriteCasterProps) => {
...
export default DesktopOrdererFavoriteCaster;
