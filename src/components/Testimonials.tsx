  ...
  const testimonials = [
    {
      ...
      company: '株式会社フォトスタジオ',
      role: 'クリエイティブディレクター',
      content: 'ROCK CASTINGのおかげで、これまで見つけることが困難だった専門性の高いキャストと出会うことができました。位置情報機能も非常に便利で、撮影現場に近いプロフェッショナルをすぐに見つけられます。',
      rating: 5
    },
    {
      name: '佐藤花子',
      company: 'フリーランス',
      role: 'ファッションモデル',
      content: 'プラットフォーム内でのメッセージ機能が安全で使いやすく、クライアントとの円滑なコミュニケーションが取れています。お仕事の依頼も増えて、とても満足しています。',
      rating: 5
    },
    {
      name: '田中次郎',
      company: '広告代理店 クリエイト',
      role: 'プロデューサー',
      content: 'パッケージ予約機能が画期的です。カメラマン、スタイリスト、モデルを一括で手配できるので、プロジェクトの管理が格段に楽になりました。コスト削減にも繋がっています。',
      rating: 5
    }
  ]
