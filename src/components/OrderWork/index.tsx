...
const CheckIcon = () => (
  <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.8333 5L7.08333 14L3 9.81818" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const OrderWork = () => {
  return (
    <div style={{ backgroundColor: "#060606", position: "relative", width: "100%" }}>
      {/* ヒーローセクション */}
      <section style={{ position: "relative", height: "408px", overflow: "hidden" }}>
        {/* 背景画像 */}
        <div style={{
          position: "absolute",
          top: 0,
          ...
          <div style={{
            ...
            <div>
              <ul style={{
                ...
                <li style={{ marginBottom: "15px" }}>・SNS・YouTube・宣材用の撮影をプロにお願いしたい</li>
                <li style={{ marginBottom: "15px" }}>・結婚式やイベントでの出張カメラマンを探したい</li>
                <li style={{ marginBottom: "15px" }}>・七五三・成人式・家族写真などの記念撮影に</li>
              </ul>
            </div>
            ...
            <div>
              <ul style={{
                ...
                <li style={{ marginBottom: "15px" }}>・広告・カタログ・CM撮影で、モデルやスタイリストを手配したい</li>
                <li style={{ marginBottom: "15px" }}>・会社のホームページや採用動画の制作を依頼したい</li>
                <li style={{ marginBottom: "15px" }}>・新商品のPR撮影・SNSコンテンツ用素材をまとめて撮りたい</li>
                <li style={{ marginBottom: "15px" }}>・撮影から編集まで、ワンストップで依頼したい</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            このような<span style={{ color: "#fead50" }}>お悩み</span>ありませんか？
          </h2>
          ...
          <div style={{
            ...
            {/* 左列 */}
            <div style={{ display: "flex", flexDirection: "column", gap: "clamp(12px, 1.5vw, 15px)" }}>
              <div style={{
                backgroundColor: "white",
                borderRadius: "30px",
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginTop: "clamp(40px, 5vw, 50px)", marginBottom: "clamp(20px, 3vw, 30px)", textAlign: "center" }}>
              <h3 style={{
