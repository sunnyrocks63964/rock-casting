...
const MobileMessage = ({ threadId, userId, otherUserName }: MessageProps) => {
        ...
        >
            ...
            >
                {getStatusBadges(status).map((badge, index) => {
                    ...
                    const badgeWidth = isDeliveryTab ? "100px" : badge.value === "scout" ? "95px" : badge.value === "negotiation" ? "87px" : badge.value === "agreed" ? "96px" : "95px";
                    const badgeHeight = "32px";
                        ...
                        >
                            ...
                            <p
                                style={{
                                    ...
                                    whiteSpace: "nowrap",
                                    textAlign: "center",
                                    width: badge.value === "scout" ? "75px" : "auto",
                                    lineHeight: "1.2",
                                    zIndex: 1,
                                    pointerEvents: "none",
                                }}
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <br />
                                                <span style={{ color: "#006eff", fontSize: "10px" }}>
                                                    ・発注者都合によるキャンセル料について
                                                </span>
                                                <br />
                                                <span style={{ color: "#006eff", fontSize: "10px" }}>
                                ...
                                >
                                    ...
                                    >
                                        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                                            <p style={{ margin: 0, fontSize: "11px", fontWeight: "700", color: "#000", fontFamily: "'Noto Sans JP', sans-serif" }}>
                                                契約金額（税込み）
                                            </p>
                                            <p style={{ margin: 0, fontSize: "11px", fontWeight: "400", color: "#000", fontFamily: "'Noto Sans JP', sans-serif" }}>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                                            ...
                                            <p style={{ margin: 0, fontSize: "11px", fontWeight: "400", color: "#000", fontFamily: "'Noto Sans JP', sans-serif", wordBreak: "break-word" }}>
                                                {agreedProposal.projectContent}
                                            </p>
                                        </div>
                                        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                                    ...
                                    {thread.cancellationReason && (
                                        ...
                                        >
                                            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                                                ...
                                                <p style={{ margin: 0, fontSize: "11px", fontWeight: "400", color: "#000", fontFamily: "'Noto Sans JP', sans-serif", whiteSpace: "pre-wrap", wordBreak: "break-word" }}>
                                                    {thread.cancellationReason}
                                                </p>
                                            </div>
                                        </div>
