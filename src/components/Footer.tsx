        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <Link href="/register/cast" className="text-gray-300 hover:text-white transition-colors">
                仕事を受ける
              </Link>
              <Link href="/casts" className="text-gray-300 hover:text-white transition-colors">
                キャスト一覧
              </Link>
              <Link href="/register/company" className="text-gray-300 hover:text-white transition-colors">
                仕事を依頼する
              </Link>
              <Link href="/login" className="text-gray-300 hover:text-white transition-colors">
                ログイン
              </Link>
              <Link href="/password-reset" className="text-gray-300 hover:text-white transition-colors">
                パスワード再設定
              </Link>
            </nav>
          </div>
          ...
          {/* 規約・運営・その他 */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">規約・運営・その他</h3>
            <nav className="flex flex-col space-y-2">
              <Link href="/terms" className="text-gray-300 hover:text-white transition-colors">
                利用規約
              </Link>
              <Link href="/trademark" className="text-gray-300 hover:text-white transition-colors">
                商標・特許
              </Link>
              ...
              <Link href="/external-transmission" className="text-gray-300 hover:text-white transition-colors">
                外部送信規律に関する公表事項
              </Link>
              <Link href="/commercial-law" className="text-gray-300 hover:text-white transition-colors">
                特定商取引法に基づく表示
              </Link>
